...
def run(params, config, capture, detector, reid):
    ...
    print("this is a test flag")
    # output_detections_numpy = np.array(output_detections)
    
    # print(len(output_detections[0]))
    # print(output_detections[0][0])

    # for i in range(len(output_detections[0])):
        # print(output_detections[0][i])
    #     send_result(output_detections[0][i])

    print(tracker.get_all_tracks_history())
...
def main():
    ...
    args.m_reid = r'/home/ubuntu/qmh/models/ir/mgn_R50-ibn.xml'
    # args.m_reid = r'/opt/intel/openvino_2021/deployment_tools/open_model_zoo/tools/downloader/intel/person-reidentification-retail-0277/FP16/person-reidentification-retail-0277.xml'
